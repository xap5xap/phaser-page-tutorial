...
export default class HelloWorldScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.physics.add.overlap(this.player, this.stars, this.collectStars, undefined, this);
  ...
  private hitBomb(p: Phaser.GameObjects.GameObject, bomb: Phaser.GameObjects.GameObject) {
  ...
  private collectStars(player: Phaser.GameObjects.GameObject, star: Phaser.GameObjects.GameObject) {
